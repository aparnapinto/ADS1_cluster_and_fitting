...
def read(datafile):
    ...
    df.drop(['Series Name', 'Series Code', 'Country Code'], axis=1,
            inplace=True)
...
plt.scatter(df_fit["2008 [YR2008]"], df_fit["2018 [YR2018]"], c=labels,
            cmap="Accent")
...
"""Now we are doing curve fitting on selected data"""


def exp_growth(t, scale, growth):
    """ 
    This function is for computing exponential function with scale and growth
    as free parameters.
    """
...
plt.savefig("curve_fitting.png", bbox_inches="tight")
plt.show()
print()
